...
const basicConfig = {
	...
	favicon: '/logo.png',
	language: 'zh-CN',
	timeEstablished: '2026-07-10',
	timeZone: 'Asia/Shanghai',
	url: 'https://blog.gnix807.top/',
	defaultCategory: '未分类',
}
...
const blogConfig = {
	...
	scripts: [
		// 自己部署的 Umami 统计服务
		{ 'src': 'https://umami.gnix807.cn/script.js', 'data-website-id': '17b2939e-a435-4d45-98c1-e4397b3d6875', 'defer': true },
		// 自己网站的 Cloudflare Insights 统计服务
		{ 'src': 'https://static.cloudflareinsights.com/beacon.min.js', 'data-cf-beacon': '{"token": "272d190c097b44e3a77731c7fef2ef5d"}', 'defer': true },
		// Twikoo 评论系统
	...
	/** 自己部署的 Twikoo 服务 */
	twikoo: {
		envId: 'https://twikoo.gnix807.cn/',
		preload: 'https://twikoo.gnix807.cn/',
	},
}
