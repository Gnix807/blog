...
这大概是我对自己说过最有用的一个类比——把 AI 想象成一个干活特别快但是没有经验的实习生。

实习生效率极高。资料整理、文案初稿、搭代码框架——全扔给他，他几分钟就可以干完你几天的活。但**你必须审核他交上来的所有东西**。报告、数据、代码——作为「导师」，你有责任检查每一条，验证事实，修正所有错误。用了这个姿势以后，我不再单纯地**使用**互联网了，我是在**驾驭**一个把这个时代最强大的信息处理引擎——而且我知道什么时候该踩刹车。
::
...
上两步过了以后，最后问自己几个问题。这个网站/博主以前的记录怎么样，严谨还是翻过车？有没有"关于我们"页面，作者信息透不透明？（包括本站的言论其实也是一样的！）
