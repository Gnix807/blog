...
::folding{title='3. Site: ：画地为牢，限定网站'}
...
::folding{title='4. Filetype: ：限定文件格式，白嫖党的神器'}
...
AI 搜索不只"搜"——它能做很多传统搜索根本搞不定的事。我举三个自己最常用的。

先说 **一键总结**。我经常对着那种 2 万字的英文报告发呆——看吧，时间不够；不看吧，又怕漏掉关键信息。现在直接扔给 AI，加一句「请用中文总结核心论点、三个关键论据和结论，用项目符号列出来」，30 秒内拿到干货。老实说，这可能是我用 AI 用得最狠的功能了。

然后是**跨语言**。有次我一个问题在国内论坛翻遍了没找到，后来让 DeepL 翻成德语、再让 AI 用德语去搜、把结果总结成中文给我——答案就在一个德国帖子里躺着。说白了，AI 就是你的 7×24 全语种翻译+情报员，只要你会下指令，语言根本不是墙。

第三个是**创意生成和写代码**。给新项目想名字想到头秃？"帮我想 10 个面向大学生的笔记 App 名"。需要一段 Python 读 Excel 删重复行但完全不会写？描述清楚需求给它就行。AI 不一定写出最优代码，但它能帮你越过那道"完全不知道从哪开始"的坎——剩下的你再调教就行。

### 驾驭AI的黑暗面（风险与规避）

AI 这东西厉害归厉害，但它有个致命的毛病——**它是一个知识量很大、但动不动就一本正经胡说八道的骗子**。说起来你可能不信：AI 并不知道自己在说什么，它只是在预测下一个词。所以有几个坑你必须心里有数。

::alert{type="error"}
**AI 幻觉——最容易踩的坑**

AI 不知道答案的时候不会说"我不知道"，它会编。而且编得特别像真的——你问它"鲁迅评价人工智能的名言"，它能给你编一句看起来很鲁迅的话，还附带出处，但你仔细查，什么都没查到。我给这个现象的忠告就一条：**对 AI 给你的事实性信息——人名、数字、日期、法条——全部当成线索，回头用搜索引擎交叉验证**。尤其是写文章、做研究报告的时候，别让自己的署名跟 AI 的幻觉绑在一起。
::

**知识截止日期。**大模型的知识都是"冻"在某个时间点的。你问它最新的新闻、刚发布的软件版本，它要么说不知道——要么更糟，它基于旧知识给你瞎推，等你指出它错了吧，有时候还跟你犟。处理当下的事，老老实实开联网搜索或者还是自己动手比较好。

**偏见。**这个可能不太好察觉，但确实存在。AI 读的是人类历史上所有公开文本——里面有性别偏见、种族偏见、各种偏见——AI 是有样学样、不加批判地复现。对它给你的观点性建议，自己动动脑子，别全盘照收就行。

::alert{type="tip"}
**我给自己立的规矩：把 AI 当实习生用**

这大概是我对自己说过最有用的一个类比——把 AI 想成那个干活贼快但没经验的实习生。

实习生效率极高。资料整理、文案初稿、搭代码框架——全扔给他，他几分钟干完你几天的活。但**你必须审核他交上来的所有东西**。报告、数据、代码——作为「导师」，你有责任检查每一条，验证每一个事实，修正每一个错误。用了这个姿势以后，我不再单纯地**使用**互联网了，我是在**驾驭**一个把这个时代最强大的信息处理引擎——而且我知道什么时候该踩刹车。
::
...
每次看到那种"震惊！XXX 宣布重大突破"转发的冲动上来时，忍一下，先走这三步。养成习惯之后，大部分谣言在你这里活不过半分钟。

::timeline
{第一步：追溯一手信源——谁说的？原始出处在哪？}

这是最管用的习惯，没有之一。看到任何让人热血沸腾的消息，先问一句：你从哪里听到的？

- 「专家表示……」——哪个专家？名字呢？在哪篇论文哪个发布会上说的？
- 「研究表明……」——哪个机构的研究？发在哪本期刊？样本量是多少？
- 「据外媒报道……」——哪家外媒？路透社还是某个你不知道名字的野鸡网站？
- 「XX 公司宣布重大技术突破！」——去这家公司官网，找「新闻稿」或「投资者关系」栏。官网没有？那你懂的。

{第二步：启动反向搜索——这张图/这段视频是真的吗？}

这年头眼见早就不一定为实了。图片被张冠李戴、旧闻新用、AI 生成以假乱真，太常见了。我的办法很简单：右键那张图，Google 搜图或者 Yandex 搜图来一下。如果它几年前就在别的新闻里出现过——那大概率是被搬来当新瓜的。视频同理，截关键帧搜图。

{第三步：检查信源和内容——这事听着靠谱吗？}

上两步过了以后，最后问自己几个问题。这个网站/博主以前的记录怎么样，严谨还是翻过车？有没有"关于我们"页面，作者信息透不透明？

看内容本身：语气是冷静陈述，还是充满了「震惊」「骇人听闻」「不转不是中国人」？有没有满篇错别字和蹩脚的语法？它说的东西跟常识打架吗？（比如「用爱发电」）

三关走完，基本不会翻车了。说到底就是一句话：别懒。
::
